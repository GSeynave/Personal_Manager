...
class TransactionControllerTest extends BaseControllerTest {
   ...
   * when(useCaseService.getAllTransactions(minDate,
   * maxDate)).thenReturn(expected);
   * 
   * // Act & Assert
   ...
   * LocalDate minDate = LocalDate.of(2024, 1, 1);
   * LocalDate maxDate = LocalDate.of(2024, 1, 31);
   * AccountingSummaryDTO summary = new AccountingSummaryDTO(2000.0, 1500.0,
   * 500.0);
   * when(useCaseService.getTransactionSummary(minDate,
   * maxDate)).thenReturn(summary);
   * 
   * // Act & Assert
   ...
   * 
   * @Test
   * void getUncategorizedTransactions_shouldReturnUncategorizedList() throws
   * Exception {
   * // Arrange
   * TransactionDTO dto = new TransactionDTO();
   * dto.setId(1);
   * UncategorizedTransactionDTO uncategorized =
   * UncategorizedTransactionDTO.builder().transactions(List.of(dto)).build();
   ...
   * 
   * @Test
   * void getUncategorizedTransactions_shouldReturnNull_whenNoneExist() throws
   * Exception {
   * // Arrange
