...
import gse.home.personalmanager.core.utils.FirebaseTokenVerifier;
 ...
 * - Mocked JwtUtils and UserAuthService to prevent FirebaseAuthenticationFilter
 * initialization errors
 * <p>
 * Usage: Extend this class and add @WebMvcTest(controllers =
...
public abstract class BaseControllerTest {
  ...
  @MockitoBean
  private FirebaseTokenVerifier jwtUtils; // Mock to prevent FirebaseAuthenticationFilter initialization error
  @MockitoBean
