...
public interface TransactionRepository extends JpaRepository<Transaction, Integer> {
  ...
  List<Transaction> findAllByDateBetweenAndWalletIdAndUserId(LocalDate minDate, LocalDate maxDate, Long walletId,
      Long userId);
  ...
  Page<Transaction> findAllByDateBetweenAndWalletIdAndUserId(
      LocalDate minDate,
      LocalDate maxDate,
      Long walletId,
      Long userId,
   ...
   * This is used to get the current balance from the transaction's currentBalance
   * field.
   */
  ...
  void deleteAllByWalletIdAndUserId(Long walletId, Long userId);
}
